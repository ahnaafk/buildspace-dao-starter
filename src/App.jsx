...
const bundleDropModule = sdk.getBundleDropModule("0x33e85ae572340d69d95E281AF79B4AC75b683318");
...
const App = () => {
  ...
  //Retrieve all of our existing proposals from the contract
  useEffect(() => {
    if (!hasClaimedNFT) {
      return;
    }
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🌱GoOutsideDAO Member Page</h1>
